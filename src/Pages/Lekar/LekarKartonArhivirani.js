        ...
        <div  style={{height:"800px"}} className='navAdmin'>
              <div  >
                <div style={{display:"flex"}}>
                  ...
                  <div style={{flex:"1"}}>   {userInfo.username===pacijent.usernameLekara &&  <button className='otpusti' ><FontAwesomeIcon style={{ marginRight: "0.6rem",color:"red" }}  icon={faDeleteLeft } size='lg' /></button>}</div> 
                </div>
...
{loadingK  ? <Loader/> : pregledi.length==0 ? <><h2 style={{marginBottom:"32rem"}}>Trenutni pacijent nema ni jedan obavljen pregled!</h2>
    ...
    <div style={{display:"flex"}}>
    {openModal ? <Modals closeModal={setOpenModal} kartonId={karton.id} lekarId={userInfo.id} success={successCreate}
