...
import { detailsPatient, prebaciPacijenta } from '../../actions/pacijentActions';
...
{userInfo.id===pacijent.idLekara ?<> <li onClick={()=>toNav("pacijent-istorija")} style={{marginLeft:"1rem"}} className="navAdminLine" >
      ...
      <Form  style={{padding:"3rem",display:"flex",flexDirection:"column", alignItems:"center"}}onSubmit={handleSubmit}>
                      ...
                      <Form.Select
                        ...
                        >
                          ...
                          {odeljenja.filter( (odeljenje) =>
                                  odeljenje.id!== idO).map((odeljenje) => (
                      ...
                      <Form.Group  style={{marginTop:"4rem"}} controlId='formBasicPrezime'>
                        ...
                        >
                          ...
                          {selectedOdeljenje &&
                            korisnici
                              .filter(
                                (korisnik) =>
                                  korisnik.odeljenjeId === selectedOdeljenje && korisnik.role==="Lekar"
                              ...
                              .map((korisnik) => (
                                <option
                                  ...
                                  value={korisnik.id}
                                >
                                  {korisnik.ime}  {korisnik.prezime} (specijalista {korisnik.specijalizacija}ije)
                                </option>
                              ))}
                      ...
                      {successPrebaci && <Message  style={{textAlign:"center",marginTop:"1rem"}} variant={"success"}>Uspesno ste premestili pacijenta</Message>}      
                      
                      {errorPrebaci && <Message  style={{textAlign:"center",marginTop:"1rem"}} children={errorPrebaci}  variant={"danger"}></Message>}              
</Form>

<p style={{padding:"3rem"}}>Kao izabrani lekar pacijenta na datom kartonu,ili na klinici imate mogucnost da ga prebacite na drugo odeljenje,pritom mu dodeljujuci izabranog lekara na novom odeljenju.</p>
